package net.ishandian.locationdemo;
 ...
 * 类名：获取当前位置的经纬度
 *
 * @Author: huangdianhua on 2018/3/30 14:04.
 * E-mail: hdh.mr.666@gmail.com
 */

public class LocationUtil {
    private static final long REFRESH_TIME = 15000L;
    ...
    public static Location getGPSLocation(@NonNull Context context) {
        ...
        android.util.Log.e("wjx","wjx------------checkSelfPermission----------ACCESS_FINE_LOCATION:-" + ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION));
        //高版本的权限检查
            if (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            android.util.Log.e("wjx","wjx------getGPSLocation-----null------");
            return null;
        }
        if (manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {//是否支持GPS定位
            ...
            android.util.Log.e("wjx","wjx------getGPSLocation-----isProviderEnabled------");
        }
        return location;
    }
    ...
    public static Location getNetWorkLocation(Context context) {
        ...
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            android.util.Log.e("wjx","wjx------getNetWorkLocation----null---");
            return null;
        }
        if (manager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {//是否支持Network定位
            ...
            android.util.Log.e("wjx","wjx------getNetWorkLocation----getLastKnownLocation---");
            /*while(location  == null)
            {
                manager.requestLocationUpdates("gps", 60000, 1, listener);
            }*/
        }
        android.util.Log.e("wjx","wjx------getNetWorkLocation----return location---");
        return location;
    }
